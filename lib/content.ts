...
export type SiteContent = {
  ...
  rvm: {
    ...
    title: string;
    description: string;
    features: Array<{ number: string; title: string; text: string; icon: "scan" | "inlet" | "screen" | "monitor" }>;
    specsTitle: string;
...
export const content: Record<Locale, SiteContent> = {
  pl: {
    ...
    rvm: {
      ...
      description: "Cztery kluczowe funkcje. Bez zbędnej złożoności.",
      features: [
        ...
        { number: "04", title: "Połączony monitoring", text: "Sprawdzaj stan urządzenia, aktywność i poziom zapełnienia zdalnie.", icon: "monitor" }
      ],
  ...
  en: {
    ...
    rvm: {
      ...
      description: "Four essential capabilities. No unnecessary complexity.",
      features: [
        ...
        { number: "04", title: "Connected monitoring", text: "View machine status, activity and capacity remotely.", icon: "monitor" }
      ],
